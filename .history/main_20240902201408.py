...
while True:
    ...
    faces = face_cascade.detectMultiScale(gray, scaleFactor=13, minNeighbors=5, minSize=(30, 30))
    ...
    for (x, y, w, h) in faces:
        ...
        # Detect smiles
        smiles = smile_cascade.detectMultiScale(roi_gray, scaleFactor=10, minNeighbors=20, minSize=(25, 25))
